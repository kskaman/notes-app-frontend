import colorIcon from "../../assets/icons/svg/icon-sun.svg";
import fontIcon from "../../assets/icons/svg/icon-font.svg";
import passwordIcon from "../../assets/icons/svg/icon-lock.svg";
